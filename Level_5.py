...
def level_five(color):
    ...
    if color == "Blue":
        ...
        player_color = Player_faller.brown_bunny
    elif color == "Purple":
        player_color = Player_faller.purple_bunny
    elif color == "Green":
        player_color = Player_faller.green_bunny 
    elif color == "Yellow":
        player_color = Player_faller.yellow_bunny   
    elif color == "White":
        player_color = Player_faller.white_bunny
    elif color == "Pink":
        player_color = Player_faller.pink_bunny
    else:
        player_color = Player_faller.black_bunny
